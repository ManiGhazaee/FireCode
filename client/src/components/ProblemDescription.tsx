    ...
    return (
        <div>
            ...
            <div className="flex flex-row ml-[26px] mt-[20px]">
                ...
                <div
                    className={`ml-[10px] ${
                        data.is_solved ? "problem-solved" : "problem-not-solved"
                    }`}
                >
                ...
                <div
                    className={`ml-[10px] ${data.is_starred ? "starred" : "not-starred"}`}
                >
                    <span>{data.is_starred ? "starred" : "not-starred"}</span>
                </div>
            </div>
            <div
                id="description-body"
                ...
                dangerouslySetInnerHTML={{
                    __html: convertMarkdownToHtml(data.description_body),
                }}
            ></div>
        </div>
    );
